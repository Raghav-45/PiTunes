...
export const YTPlayer = ((props) => {
  ...
  return (
    ...
    <ReactPlayer url={`https://music.youtube.com/watch?v=${MusicSourceURL}`} height={'auto'} width={'100%'} playing={IsPlaying} controls={true} onDuration={(e) => setMusicDuration(e)} muted={false} onProgress={(e) => setMusicCurrentTime(e.playedSeconds)} />
  )
})
